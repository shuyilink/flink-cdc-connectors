 ...
 */
 ...
 public class MySqlTableSourceFactory implements DynamicTableSourceFactory {
     ...
     public DynamicTableSource createDynamicTableSource(Context context) {
         ...
         // generate server id from table name hashcode
         Random rand = new Random();
         int iRandom = rand.nextInt(1000000);
         String serverIdSource =
                 String.join("-", databaseName, tableName, Integer.toString(iRandom));
         int iServerId = Math.abs(serverIdSource.hashCode());
         String serverId = Integer.toString(iServerId);
         LOGGER.info("----log server id {} {}", tableName, serverId);
